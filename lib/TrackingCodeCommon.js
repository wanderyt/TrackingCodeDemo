...
var TrackingCode = function() {
  ...
  this.baidu_analytic = function(brand, entrance, trackingCodeObj) {
    if (brand === trackingCodeObj.vipabc && entrance === trackingCodeObj.landing_page) {
      ...
      scriptTag.src = "https:" == document.location.protocol ? " https://" : " http://" + "hm.baidu.com/h.js%3F2a7cd7f558a2719125a9944d07758281";
      ...
      var scriptTag = document.createElement("script");
      scriptTag.src = "https:" == document.location.protocol ? " https://" : " http://" + "hm.baidu.com/h.js%3F8943e7e4df101bd850a8c82e95ed4b14";
      scriptTag.type = "text/javascript";
      var scriptFlag = document.getElementsByTagName("script")[0];
      scriptFlag.parentNode.insertBefore(scriptTag, scriptFlag);
    }
  ...
  this.sogou = function(brand, entrance, trackingCodeObj) {
    if (brand !== trackingCodeObj.invalid_brand && entrance !== trackingCodeObj.invalid_entrance) {
      var _sogou_sa_q = window._sogou_sa_q || [];
      window._sogou_sa_q = _sogou_sa_q;
      _sogou_sa_q.push(['_sid', '87011-89433']);
      var scriptTag = document.createElement("script");
      scriptTag.src = "https:" == document.location.protocol ? " https://" : " http://" + "hermes.sogou.com/sa.js%3Fsid%3D87011-89433";
      scriptTag.type = "text/javascript";
      var scriptFlag = document.getElementsByTagName("script")[0];
      scriptFlag.parentNode.insertBefore(scriptTag, scriptFlag);
    }
   ...
   * Lastest Node @2016-06-23: All flow data operation will be placed in submit process.
  ...
  /**
   * pinyou callback functino when submit is success
   * @param  {[type]} uuid        [description]
   * @param  {[type]} productList [description]
   * @return {[type]}             [description]
   */
  this.pinyouSuccessCallback = function(uuid, productList) {
    var w = window,
      d = document,
    ...
    u = '//stats.ipinyou.com/cvt?a=' + e('uc.Ods.zELX2ZwzUiOZG4tMT0LGT0') + '&c=' + e(h ? h[2] : '') + '&s=' + e(i ? i[2].match(/jump\%3D(\d+)/)[1] : '') + '&u=' + e(b) + '&r=' + e(c) + '&rd=' + (new Date()).getTime() + '&OrderNo=' + e(uuid) + '&ProductList=' + e(productList) + '&e=';
    (new Image()).src = u;
  }
