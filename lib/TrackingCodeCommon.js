...
var TrackingCode = function() {
  ...
  this.baidu_analytic = function(brand, entrance, trackingCodeObj) {
    if (brand === trackingCodeObj.VIPABC_ADULT && entrance === trackingCodeObj.LANDING_PAGE) {
    ...
    } else if (brand === trackingCodeObj.VIPABC_JUNIOR && entrance === trackingCodeObj.LANDING_PAGE) {
  ...
  this.google_analytic = function(brand, entrance, trackingCodeObj) {
    if (brand === trackingCodeObj.VIPABC_ADULT) {
      /**
    ...
    } else if (brand === trackingCodeObj.VIPABC_JUNIOR) {
      /**
