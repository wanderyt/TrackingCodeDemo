...
var TrackingCode = function() {
   ...
   */
  this.init = function(brand, entrance, options) {
    // brand = brand || this.VIPABC_ADULT;
    // entrance = entrance || this.LANDING_PAGE;
  ...
  this.baidu_analytic = function(brand, entrance) {
    if (brand === this.VIPABC_ADULT && entrance === this.LANDING_PAGE) {
    ...
    } else if (brand === this.VIPABC_JUNIOR && entrance === this.LANDING_PAGE) {
  ...
  this.google_analytic = function(brand, entrance) {
    if (brand === this.VIPABC_ADULT) {
      /**
       * Google Analysis Code For vipabc adult
       */
      if (entrance === this.OFFICIAL_WEBSITE) {
      ...
      } else if (entrance === this.LANDING_PAGE) {
    ...
    } else if (brand === this.VIPABC_JUNIOR) {
      /**
  ...
  this.jingzan = function(brand, entrance) {
    if (brand !== this.INVALID_BRAND && entrance !== this.INVALID_ENTRANCE) {
      (function(param) {
        var c = {
          query: [],
          args: param || {}
  ...
  this.pinyou_dsp = function(brand, entrance) {
    if (brand !== this.INVALID_BRAND && entrance !== this.INVALID_ENTRANCE) {
      var _py = window._py || [];
      window._py = _py;
  ...
  this.baidu_dsp = function(brand, entrance) {
    if (brand === this.VIPABC_ADULT && entrance === this.LANDING_PAGE) {
      var _hmt = _hmt || [];
      (function() {
  ...
  this.gridsum = function(brand, entrance) {
    if (brand !== this.INVALID_BRAND && entrance !== this.INVALID_ENTRANCE) {
      var s = document.createElement("script");
  ...
  this.admaster = function(brand, entrance) {
    if (brand !== this.INVALID_BRAND && entrance !== this.INVALID_ENTRANCE) {
      var _smq = _smq || [];
  ...
  this.mediav = function(brand, entrance) {
    if (brand !== this.INVALID_BRAND && entrance !== this.INVALID_ENTRANCE) {
  ...
  this.xad = function(brand, entrance) {
    if (brand !== this.INVALID_BRAND && entrance !== this.INVALID_ENTRANCE) {
  ...
  this.sogou = function(brand, entrance) {
