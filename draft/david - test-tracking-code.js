    ...
    google_analytic(brand, entrance) {
      if (brand === 0) {
        ...
        if (entrance === "OW") {
          ...
          scriptFlag.parentNode.insertBefore(noscriptTag);
          scriptFlag.parentNode.insertBefore(scriptTag);
        } else {
          ...
          var scriptFlag = document.getElementsByTagName("script")[0];
          scriptFlag.parentNode.insertBefore(scriptFlag);
          scriptFlag.parentNode.insertBefore(noscriptTag);
        }
      } else {
        /**
        ...
        if (entrance === "OW") {
          ...
          noscriptTag.appendChild(divTag);
          var scriptFlag = document.getElementsByTagName("script")[0];
          scriptFlag.parentNode.insertBefore(scriptTagOne);
          scriptFlag.parentNode.insertBefore(scriptTagTwo);
          scriptFlag.parentNode.insertBefore(noscriptTag);
        } else {
